...
const I18N_DICT = {
  en: {
    ...
    'login.subtitle': 'Enter your access token',
    'login.errBadToken': 'Wrong token, please try again.',
    'login.placeholder': 'AUTH_TOKEN',
    'login.submit': 'Enter',
  ...
  zh: {
    ...
    'login.subtitle': '输入访问令牌',
    'login.errBadToken': '令牌错误，请重试。',
    'login.placeholder': 'AUTH_TOKEN',
    'login.submit': '进入',
